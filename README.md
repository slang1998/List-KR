...
Most of rules are following the grammer of [Adblock Plus][], some rules for more difficult filtering utilizes Adguard's advanced filtering methods, and will not be activated in other filtering tools. [ublock origin] is known to be compatible with only part of the rules and can be used with this filter.
