...
#### 인터넷 익스플로러에 대해서
인터넷 익스플로러는 크롬, 파이어폭스 등과 렌더링 방식에 차이가 있어, 기존 확장 프로그램에서 사용하도록 제작된 필터를 IE에 적용할 경우 차단 결과가 다를 수 있습니다. 이 필터 또한 기존에 존재하던 필터들에 기반하여 작성되었기 때문에 IE에서만 차단되지 않는 광고가 있을 수 있습니다. 이러한 현상이 발견되면 관련 규칙을 IE에도 적용되도록 변경합니다.
